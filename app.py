...
def process_checklist_data(uploaded_file):
    ...
    try:
        ...
        metadata = {
            'Date_of_Audit': df_metadata.iloc[4, 4],
            'Time_Shift': df_metadata.iloc[4, 6],
            'Factory': df_metadata.iloc[5, 4],
            'Work_Area': df_metadata.iloc[5, 6],
            'Observed_Personnel': df_metadata.iloc[6, 4],
            'Supervisor': df_metadata.iloc[6, 6],
            'Machine_ID': df_metadata.iloc[7, 4],
            'Auditor': df_metadata.iloc[7, 6],
